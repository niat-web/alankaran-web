    ...
    <div className="bg-background text-foreground">
      ...
      <section className="relative h-[70vh] flex items-end pb-20 overflow-hidden">
        ...
        <div className="relative max-w-screen-xl mx-auto px-6 lg:px-12 z-20">
          <motion.p className="section-label mb-4 text-gold" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            About Alankaran
          </motion.p>
          <motion.h1 className="text-display text-5xl lg:text-8xl text-white" initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }}>
            Our Story
          </motion.h1>
        </div>
      </section>
      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-12">
        ...
        <section className="py-24 lg:py-32 text-center relative overflow-hidden">
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-8 relative z-10">
            <Link href="/contact">
              <motion.button className="px-8 py-3 bg-gold text-white section-label hover:bg-gold/90 transition-all" whileHover={{ scale: 1.02 }}>
                Begin Your Wedding Story
              </motion.button>
            </Link>
            <Link href="/contact">
              <motion.button className="px-8 py-3 btn-outline-gold section-label transition-all" whileHover={{ scale: 1.02 }}>
                Get a Quote
              </motion.button>
            </Link>
          </div>
